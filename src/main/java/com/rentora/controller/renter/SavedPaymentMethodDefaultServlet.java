...
@WebServlet("/renter/payment-methods/default")
public class SavedPaymentMethodDefaultServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            service.setDefault(id, user.getUserId());
            session.setAttribute("successMessage", "Default payment method updated.");
        } catch (Exception e) {
            session.setAttribute("errorMessage", "Could not update your default payment method.");
        }
